...
const StudentCourses = () => {
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: '20px', fontWeight: '600', marginBottom: '8px' }}>Error Loading Courses</h2>
          <p>{error}</p>
        </div>
      </div>
    );
  ...
  return (
    <>
      <Helmet>
        <title>My Courses — MSK Institute</title>
        <meta name="robots" content="noindex, nofollow" />
        <meta name="description" content="View and manage your enrolled courses at MSK Institute." />
      </Helmet>
