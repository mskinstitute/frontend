...
const CourseForm = () => {
  return (
    <div className="min-h-screen bg-gray-900 text-white flex items-center justify-center px-4">
      <Helmet><title>Course Form – MSK Institute</title></Helmet>
      <div className="text-center max-w-md bg-gray-800 p-8 rounded-2xl border border-gray-700">
        ...
        <h2 className="text-2xl font-bold text-white mb-2">Course Form</h2>
        <p className="text-gray-400 mb-6">Course management is currently unavailable in offline mode.</p>
